...
#for j in range(0,1):
    ...
    NDVI_avg_grids.append(NDVI_avg_grid)
...
for k in range(0,len(NDVI_avg_grids)):
#for k in range(0,1):
    print 'Index', k
    NDVI_grid = NDVI_avg_grids[k]
...
cb.set_label('NDVI')
axis1.set_title('NDVI Average 2000-2009')
...
fig.savefig('MODIS_data_3/NDVI_July_avg_Figure.png')
