...
#for j in range(0,1):
    ...
    EVI_avg_grids.append(EVI_avg_grid)
...
for k in range(0,len(EVI_avg_grids)):
#for k in range(0,1):
    print 'Index', k
    evi_grid = EVI_avg_grids[k]
...
cb.set_label('EVI')
axis1.set_title('EVI Average 2000-2009')
...
fig.savefig('MODIS_data_3/EVI_July_avg_Figure.png')
