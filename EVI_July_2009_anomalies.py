...
#for j in range(0,1):
    ...
    EVI_2009_anomalies = EVI_grids[index] - EVI_avg_grid

    if j ==1:
            evi_anomalies_dct = {}
            evi_anomalies_dct[str(a)] = EVI_2009_anomalies
    ...
    EVI_2009_anomalies_grids.append(EVI_2009_anomalies)
...
for k in range(0,len(EVI_2009_anomalies_grids)):
#for k in range(0,1):
    print 'Index', k
    evi_grid = EVI_2009_anomalies_grids[k]
...
cb.set_label('EVI')
axis1.set_title('EVI Anomalies 2009')
...
fig.savefig('MODIS_data_3/EVI_July_2009_anomalies_Figure.png')
