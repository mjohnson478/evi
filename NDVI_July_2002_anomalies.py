...
#for j in range(0,1):
    ...
    NDVI_2002_anomalies = NDVI_grids[index] - NDVI_avg_grid

    # if j ==1:
    #         NDVI_anomalies_dct = {}
    #         NDVI_anomalies_dct[str(a)] = NDVI_2002_anomalies
    ...
    NDVI_2002_anomalies_grids.append(NDVI_2002_anomalies)
...
for k in range(0,len(NDVI_2002_anomalies_grids)):
#for k in range(0,1):
    print 'Index', k
    NDVI_grid = NDVI_2002_anomalies_grids[k]
...
cb.set_label('NDVI')
axis1.set_title('NDVI Anomalies 2002')
...
fig.savefig('MODIS_data_3/NDVI_July_2002_anomalies_Figure.png')
